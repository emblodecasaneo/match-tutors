...
@section('subtitle', 'Nouveau tuteur')
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-gradient text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 text-black">Ajouter un nouveau tuteur</h5>
                        <small class="text-black">Remplissez les informations du tuteur</small>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name') }}" placeholder="Nom complet" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" 
                                       id="phone" name="phone" value="{{ old('phone') }}" placeholder="Téléphone">
                        ...
                        <div class="col-md-8">
                            <div class="form-floating">
                                <textarea class="form-control @error('bio') is-invalid @enderror" 
                                          id="bio" name="bio" style="height: 60px" placeholder="Biographie">{{ old('bio') }}</textarea>
                            ...
                            <div class="levels-grid-compact">
                                <div class="form-check form-check-compact">
                                    <input class="form-check-input" type="checkbox" name="school_levels[]" 
                                           value="college" id="college" {{ in_array('college', old('school_levels', [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="college">Collège</label>
                                </div>
                                <div class="form-check form-check-compact">
                                    <input class="form-check-input" type="checkbox" name="school_levels[]" 
                                           value="lycee" id="lycee" {{ in_array('lycee', old('school_levels', [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="lycee">Lycée</label>
                                </div>
                                <div class="form-check form-check-compact">
                                    <input class="form-check-input" type="checkbox" name="school_levels[]" 
                                           value="terminale" id="terminale" {{ in_array('terminale', old('school_levels', [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="terminale">Terminale</label>
                                </div>
                                <div class="form-check form-check-compact">
                                    <input class="form-check-input" type="checkbox" name="school_levels[]" 
                                           value="university" id="university" {{ in_array('university', old('school_levels', [])) ? 'checked' : '' }}>
