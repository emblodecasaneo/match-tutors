...
@section('subtitle', 'Nouvel étudiant')
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-gradient text-white" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0 text-black">Ajouter un nouvel étudiant</h5>
                        <small class="text-black">Remplissez les informations de l'étudiant</small>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                <select class="form-select @error('school_level') is-invalid @enderror" 
                                    ...
                                    <option value="terminale" {{ old('school_level') == 'terminale' ? 'selected' : '' }}>Terminale</option>
                                    <option value="university" {{ old('school_level') == 'university' ? 'selected' : '' }}>Université</option>
                                </select>
                        ...
                        <div class="col-md-8">
                            <div class="form-floating">
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          id="notes" name="notes" style="height: 60px" placeholder="Notes">{{ old('notes') }}</textarea>
